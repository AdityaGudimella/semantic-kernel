...
class AzureTextCompletion(
    ...
    _openai_text_completion: OpenAITextCompletion = pdt.PrivateAttr()
    ...
    def __init__(self, **data: t.Any) -> None:
        super().__init__(**data)
        self._openai_text_completion = OpenAITextCompletion(
    ...
    async def complete_async(self, *args: t.Any, **kwargs: t.Any) -> t.Any:
        return self._openai_text_completion.complete_async(*args, **kwargs)

    async def complete_stream_async(self, *args: t.Any, **kwargs: t.Any) -> t.Any:
        return self._openai_text_completion.complete_stream_async(*args, **kwargs)
